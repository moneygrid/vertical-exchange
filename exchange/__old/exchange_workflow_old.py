...
class ExchangeTransaction(orm.Model):
    """
    ...
    def _default_model(self, cr, uid, context=None):
        # Return the model by default, which is exchange.transaction.
        # Otherwise, the workflow will be disabled
        proxy = self.pool.get('ir.model.data')
        result = proxy.get_object_reference(
            cr, uid, 'exchange', 'model_exchange_transaction'
        )
        return result[1]
    ...
    def create(self, cr, uid, vals, context=None):
        res = super(ExchangeTransaction, self).create(
    ...
    def write(self, cr, uid, ids, vals, context=None):
        res = super(ExchangeTransaction, self).write(
...
class ResPartner(orm.Model):
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        if 'exchange_account_ids' in vals:
