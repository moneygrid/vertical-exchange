...
class AccountWalletCurrencyLine(orm.Model):
    ...
    Theses object can be linked to other object than exchange.transaction
    """

    _name = 'exchange.currency.line'
...
class AccountWalletTransaction(orm.Model):
    ...
    _track = {
        'state': {
            'exchange.mt_transaction_state': lambda self,
